...
export async function renderFolderView(items, path, request) {
  ...
  const intro = `<div class="intro markdown-body" style="text-align: left; margin-top: 2rem;">
                    <h2>Yoo, I'm Kusakabe Si 👋</h2>
                    <p>This is Kusakabe's OneDrive public directory listing. Feel free to download any files that you find useful. Reach me at: si@kskb.eu.org.</p>
                    <p><a href="https://kskb.eu.org">Portfolio</a> · <a href="https://www.kskb.eu.org">Blog</a> · <a href="https://github.com/KusakabeSi">GitHub</a></p>
                  </div>`
